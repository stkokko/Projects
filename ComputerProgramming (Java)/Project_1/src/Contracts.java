...
public class Contracts {
	...
	public void updateStats() {
		...
		int sms;
		if(getServiceName().equals ("Programm1") || getServiceName().equals ("Programm2")){
			...
			sms = in.nextInt();
			setSmsUsed(sms);
		}else if(getServiceName().equals ("Card1") || getServiceName().equals ("Card2")){
			System.out.println("Enter monthly mobile talk time used: ");
			mobile = in.nextDouble();
			setTalkTimeHomeUsed(mobile);
			System.out.println("Enter monthly home talk time used: ");
			...
			sms = in.nextInt();
			setSmsUsed(sms);
		}else if (getServiceName().equals ("Mobile Internet1") || getServiceName().equals ("Mobile Internet2")){
