public abstract  class MobileTelephony extends Services {
	...
	public abstract void getFreeMobileTimeBalance(Contracts m);
	public abstract void getFreeHomeTimeBalance(Contracts h);
	public abstract void getFreeSmsBalance(Contracts s);
}